...
const Comment = ({commentData}) => {
  ...
  const commentBelongsToUser = userData.username === commentData.author.username; 
  ...
  const isDeleting = affectedComment && affectedComment.type === 'deleting' && affectedComment._id === commentData._id
                ...
                {commentBelongsToUser && (
                    <>
                        <button 
                            ...
                            onClick={() => setAffectedComment({type: 'editing', _id: commentData._id})}
                        >
                        ...
                        <button 
                            className='flex items-center space-x-2' 
                            onClick={() => setAffectedComment({type: 'deleting', _id: commentData._id})}
                        >
