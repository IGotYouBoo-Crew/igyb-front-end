        ...
        <div className='px-6 md:px-0'>
            <div className='flex flex-col gap-y-2.5 mt-12 relative md:w-3/4 md:left-[12.5%] lg:w-2/3 lg:left-[16.67%]'>
                <div className='relative'>
                    ...
                    <input 
                        className='placeholder:font-bold placeholder:uppercase text-black text-sm md:text-base placeholder:text-sm md:placeholder:text-base placeholder:text-[#959EAD] rounded-3xl pl-12 pr-3 w-full py-3 focus:outline-non shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px]' 
                        type="text"
                        placeholder='Search Forum Posts' 
                    />
                </div>
                
                <button className='bg-periwinkle text-white uppercase text-sm md:text-base font-bold rounded-r-3xl px-3 md:px-8 absolute right-0 top-1/2 -translate-y-1/2 w-fit py-3'>
                    Search
                </button>
            </div>
        </div>
