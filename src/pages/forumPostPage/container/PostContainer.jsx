...
const PostContainer = () => {
  ...
  return (
    <article className='flex-1 bg-honey rounded-3xl relative flex flex-col px-6 py-2'>
          ...
          {post ?
          <>
          <h4 className='text-sm font-bold text-white opacity-70 md:px-20 lg:px-12 lg:mt-4'>By {post.author.fullName || "Deleted User"} (@{post.author.username || "deleteduser"})</h4>
          <h4 className='text-sm text-white opacity-70 md:px-20 lg:px-12 '>created on {post.date}</h4>
          <div className='lg:flex lg:flex-row-reverse lg:justify-between md:px-20 lg:px-12 lg:pb-10'>
            ...
            <div className='text-white mt-6 text-center lg:text-left'>
              <h1 className='text-2xl font-bold md:text-3xl capitalize'>{post.title}</h1>
