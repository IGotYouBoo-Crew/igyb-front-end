  ...
  return (
    <section className='relative'>
        ...
        <div className='-mt-6 relative  bg-indigo text-background rounded-3xl flex flex-col px-10 lg:px-20 py-10 justify-center items-center'>
            <h1 className='font-bold text-2xl md:text-3xl text-center uppercase'>Welcome to the club</h1>
        ...
        <div className='md:h-160 -mt-6 w-screen bg-cover bg-center flex flex-col justify-center items-center md:flex-row-reverse'>
            ...
            <div className='h-full md:w-1/2 bg-background  text-sea flex flex-col px-10 lg:px-20 pt-12 pb-20 justify-center items-center md:items-start'>
                ...
                <NavLink to="/events">
                    <button className='mt-4 border-2 font-bold border-sea rounded-3xl px-5 py-2 uppercase'>
                        Events
                    </button>
                </NavLink>
