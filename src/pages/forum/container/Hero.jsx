...
const Hero = () => {
  return (
    <section className='lg:-mt-5'>
        ...
        <div className='bg-honey rounded-3xl z-40 p-10 text-white relative -mt-10 lg:-mt-16'>
            <div className='lg:flex md:justify-between'>
                ...
                <div className='mt-8 lg:mt-0 text-center lg:w-1/2 lg:text-end lg:pr-28'>
                    ...
                    <button className='font-bold bg-periwinkle rounded-3xl px-5 py-2 mt-2 lg:text-xl'>
                        CREATE A POST
                    </button>
                </div>
            </div>
