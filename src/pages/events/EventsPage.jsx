...
const EventsPage = () => {
    return (
      <MainLayout>
        ...
        <img className='z-10 relative -mt-6 w-full' src={images.EventHeader} alt="Header" />
        <div className=' -mt-6 z-40 relative bg-indigo text-white rounded-3xl flex flex-col px-10 lg:px-20 py-10 items-center md:flex-row md:items-start md:justify-between'>
