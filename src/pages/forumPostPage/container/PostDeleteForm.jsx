...
const PostDeleteForm = ({post, initialText = "", formCancelHandler = null, formSubmitHandler, loading = false}) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col bg-white rounded-3xl items-end px-5 py-2 mt-6 mb-4">
      <h1 className='w-full background-transparent text-red-500'>Are you sure you want to delete this post?</h1>
